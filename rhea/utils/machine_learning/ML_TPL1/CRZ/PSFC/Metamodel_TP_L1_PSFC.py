...
###################################################
file_name = "C:/Users/LA202059/Desktop/RHEA/rhea/resources/gasturbine/TP_L1/Datapacks/TP_L1_deck_CRZ.txt"
data = pd.read_csv(file_name, sep="\t")
data.drop(['SHP'],axis=1,inplace=True)
n_rows= data.shape[0]
