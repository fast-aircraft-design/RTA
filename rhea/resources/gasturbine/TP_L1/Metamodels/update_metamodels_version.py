...
print("WARNING: scikit-learn version compatibility check must be done before rewritting the models.")
print("Should the metamodels be rewritten with sklearn version {} (y/n)?".format(sklearn_version))
user_answer = input()
