...
from rhea.base.dict import DynamicAttributeDict, AddKeyAttributes
...
LABELS = {
    ...
    "shaft_power": dict(doc="Slope angle in radians."),
    "power_rate": dict(doc="Acceleration value in m/s**2."),
    "thermo_power": dict(doc="Name of current phase."),
}
