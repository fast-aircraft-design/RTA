...
class TakeOffSpeeds(TakeOffSegment):
    ...
    def find_speeds(self, start):
        ...
        def find_v2(factor):
            ...
            )  # negleting effects (because we don't have alpha at this point) but also reguulations requirements impose not to consider ground effect and gear are retracted (so no lg effect)
            climb_rate = (
