...
class DOCFlight_RHEA(SizingFlight_RHEA):
    ...
    def setup(self):
        ...
        self.add_input("data:aerodynamics:aircraft:takeoff:CT_effect:DCL0", np.nan, copy_shape="data:aerodynamics:aircraft:low_speed:CT")
        self.add_input("data:aerodynamics:aircraft:takeoff:CT_effect:DCL_alpha", np.nan,units="1/rad",copy_shape="data:aerodynamics:aircraft:low_speed:CT")
        ...
        self.add_input("data:aerodynamics:aircraft:takeoff:ground_effect:DCD", np.nan,copy_shape="data:aerodynamics:aircraft:low_speed:alpha")
        self.add_input("data:aerodynamics:aircraft:takeoff:ground_effect:DCL", np.nan,copy_shape="data:aerodynamics:aircraft:low_speed:alpha")
        self.add_input("data:aerodynamics:aircraft:takeoff:ground_effect:K_H", np.nan,copy_shape="data:aerodynamics:aircraft:low_speed:H")
        ...
        self.add_input("data:mission:DOC:takeoff:EM_power_rate", 0.)
        self.add_input("data:mission:DOC:takeoff:TP_power_rate", 1.)        
        self.add_input("data:mission:DOC:initial_climb:EM_power_rate", 0.)
        self.add_input("data:mission:DOC:initial_climb:TP_power_rate", 1.)       
        self.add_input("data:mission:DOC:climb:EM_power_rate", 0.,shape=POWER_RATE_COUNT)
        self.add_input("data:mission:DOC:climb:TP_power_rate", 1.,shape=POWER_RATE_COUNT)        
        self.add_input("data:mission:DOC:cruise:EM_power_rate", 0.)
        self.add_input("data:mission:DOC:cruise:TP_power_rate", 1.)      
        
                
        self.add_input("data:mission:DOC:diversion:climb:EM_power_rate", 0.)
        self.add_input("data:mission:DOC:diversion:climb:TP_power_rate",1.)               
        self.add_input("data:mission:DOC:diversion:cruise:EM_power_rate", 0.)
        self.add_input("data:mission:DOC:diversion:cruise:TP_power_rate", 1.)  
        ...
        self.add_input("data:mission:DOC:taxi_out:duration", 360., units="s")
        self.add_input("data:mission:DOC:takeoff:duration", 60., units="s")
        self.add_input("data:mission:DOC:landing:duration", 120., units="s")
        self.add_input("data:mission:DOC:taxi_in:duration", 240., units="s")
        ...
        self.add_output("data:mission:DOC:diversion:climb:operational_ceiling",0,units="m")
        ...
        self.add_output("data:mission:DOC:diversion:climb:fuel", units="kg",val=0.)
        self.add_output("data:mission:DOC:diversion:cruise:fuel", units="kg",val=0.)
        self.add_output("data:mission:DOC:diversion:descent:fuel", units="kg",val=0.)
        ...
        self.add_output("data:mission:DOC:diversion:climb:distance", units="m",val=0.)
        self.add_output("data:mission:DOC:diversion:cruise:distance", units="m",val=0.)
        self.add_output("data:mission:DOC:diversion:descent:distance", units="m",val=0.)

        self.add_output("data:mission:DOC:diversion:climb:duration", units="s",val=0.)
        self.add_output("data:mission:DOC:diversion:cruise:duration", units="s",val=0.)
        self.add_output("data:mission:DOC:diversion:descent:duration", units="s",val=0.)
        ...
        self.add_output("data:mission:DOC:BAT_energy", units="J", val=0.)
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        try:
            ...
            sol= root_scalar(compute_point, x0=0.9*TOW_input, x1=0.7*TOW_input, rtol=tol,method='secant')
