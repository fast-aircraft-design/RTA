...
class TP_sizing(ExplicitComponent):
    """
    Performs sizing of the turboprop based on input termodynamic and mechanical power. Determines off-design parameters.
    """
    # def __init__(self):
    #     super().__init__()
    #     self.ram = Ram() 
    ...
    def setup(self):
        ...
        # self.add_input("data:propulsion:mach", np.nan)
        # self.add_input("data:propulsion:altitude", np.nan, units="m")
        ...
        # self.add_input("data:propulsion:L1_engine:HP_bleed", np.nan)
        # self.add_input("data:propulsion:L1_engine:LP_bleed", np.nan)
    ...
    def compute(self, inputs, outputs):   
        ...
        shaft_power_adim,fuel_to_air_ratio,specific_energy,jet_power_adim,residual_thrust_nd,tau_ram,tau_lpc,tau_hpc,tau_b,pi_pt,tau_pt, pi_hpc, pi_lpc, pi_ram, pi_hpt, pi_lpt, tau_t,M_out_sizing = self.compute_static_power_adim(inputs)
...
#         # calculation of thermal efficiency
        ...
        # print(air_flow,fuel_flow,jet_thrust,thermal_efficiency,ESHP*0.00134102,Design_Thermo_Power*1.34102)
...
#        print 'lpt', lpt.stagnation_pressure_in/lpt.stagnation_pressure_out,lpt.stagnation_temperature_out,lpt.stagnation_pressure_out,lpt.stagnation_enthalpy_out    
        ...
        thrust.compute_design(atmosphere, mach,lpt.bleed_offtake *hpt.bleed_offtake, pt_eta_mech,pt_eta_pol,nozzle_pressure_ratio,nozzle_eta_pol)     
