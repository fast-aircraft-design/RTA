...
class PHFCEngine_L1(AbstractHybridPropulsion):
    ...
    def compute_flight_points(self, flight_points: Union[FlightPoint, pd.DataFrame]):
        ...
        (
            ...
            max_TPshaft_power,
            engine_charac,
        ) = self.max_power(atmosphere, mach, phase)
        ...
        (
            ...
            EM_power_rate,
            thrust_rate,
        ) = self.Constant_elec_power_Variable_TTC(
            atmosphere,
            mach,
            flight_points,
            max_shaft_power,
        ...
        (
            ...
            engine_charac,
            thermo_data,
        ) = self.turbine.compute_engine_point(atmosphere, mach, phase, turbine_power)
        ...
        fc_stack_power = (
            fuel_cell_power / self.Gross_net_power_ratio + self.FC_Power_Offtake
        )
    ...
    def max_power(
        ...
        (
            ...
            engine_charac,
            thermo_data,
        ) = self.turbine.compute_power(atmosphere, mach, phase, self.T4)
