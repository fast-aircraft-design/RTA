...
#        return bat_power
    ...
    def battery_sizing(self, ec, power):
        ...
        v_batt1 = ec / self.aircraft.vars_propulsion_hybrid_dep['battery_energy_density']/1000.
        v_batt2 = power/self.aircraft.vars_propulsion_hybrid_dep['battery_power_density']/1000.
