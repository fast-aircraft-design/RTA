...
from ..hybrid_engine.base import AbstractHybridPropulsion
...
from ..turboprop_engine.TP_engine_L0 import TPEngine_L0
...
class PHFCEngine_L0(AbstractHybridPropulsion):
    ...
    def compute_flight_points(self, flight_points: Union[FlightPoint, pd.DataFrame]):
        ...
        (
            ...
            TP_power_rate,
            EM_power_rate,
        ) = self.Constant_elec_power_Constant_TTC(
            atmosphere,
            mach,
            phase,
            max_shaft_power,
        ...
        psfc = psfc_0 * self.turbine.sfc_ratio(
            atmosphere, mach, TP_power_rate, turbine_power
        )  # lb/hp/hr
        ...
        FC_H2 = self.fuel_cell.get_fc_perfo(
            fuel_cell_power, power_flow="downstream"
        )  # kg/s
