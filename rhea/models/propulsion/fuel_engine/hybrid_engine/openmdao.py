...
class OMPHEBEngineMLL1Wrapper(IOMPropulsionWrapper):
    ...
    def setup(self, component: Component):
        ...
        component.add_input("data:propulsion:electric_systems:power_electronics:power_electronics_eta", np.nan)
        ...
        component.add_input("data:propulsion:electric_systems:battery:specific_energy", np.nan,  units="W*h/kg")
        component.add_input("data:propulsion:electric_systems:battery:specific_power", np.nan, units="W/kg")
        component.add_input("data:propulsion:electric_systems:battery:battery_SOCmin", np.nan)
    ...
    def get_model(inputs) -> IPropulsion:
        ...
        engine_params = {
            ...
            "power_electronics_eta": inputs["data:propulsion:electric_systems:power_electronics:power_electronics_eta"],
            ...
            "battery_SOCmin": inputs["data:propulsion:electric_systems:battery:battery_SOCmin"],
            "battery_Esp": inputs["data:propulsion:electric_systems:battery:specific_energy"],
            "battery_Psp": inputs["data:propulsion:electric_systems:battery:specific_power"],
...
class OMPHEBEngineMLL1Component(BaseOMPropulsionComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:propulsion:EM_power_rate", shape=shape, lower=0.0, upper=1.0)
...
class OMPHFCEngineML_L1Wrapper(IOMPropulsionWrapper):
    ...
    def setup(self, component: Component):
        ...
        component.add_input("data:propulsion:electric_systems:fuel_cell:polarization_curve:V", np.nan,shape=771)
        component.add_input("data:propulsion:electric_systems:fuel_cell:polarization_curve:i", np.nan,shape=771)
        component.add_input("data:propulsion:electric_systems:fuel_cell:layout:stacks", np.nan) 
        component.add_input("data:propulsion:electric_systems:fuel_cell:layout:packs", np.nan) 
        component.add_input("data:propulsion:electric_systems:fuel_cell:sizing:A_cell", np.nan,units="m**2") 
 
        component.add_input("data:propulsion:electric_systems:fuel_cell:layout:cells", np.nan)
        component.add_input("data:geometry:propulsion:motor:count", np.nan)
        #component.add_output("data:propulsion:shaft_power", units="W")
        #component.add_output("data:propulsion:power_rate")
        component.add_input("data:propulsion:electric_systems:fuel_cell:Power_Offtake", np.nan, units="W") 
        component.add_input("data:propulsion:electric_systems:fuel_cell:Gross_net_power_ratio", np.nan)   
    ...
    def get_model(inputs) -> IPropulsion:
        ...
        engine_params = {
            ...
            "V_vec": inputs["data:propulsion:electric_systems:fuel_cell:polarization_curve:V"],
            "i_vec":inputs["data:propulsion:electric_systems:fuel_cell:polarization_curve:i"],
            "Nstacks":inputs["data:propulsion:electric_systems:fuel_cell:layout:stacks"],
            ...
            "Nmotors":inputs["data:geometry:propulsion:motor:count"], 
            "FC_Power_Offtake": inputs["data:propulsion:electric_systems:fuel_cell:Power_Offtake"],
...
class OMPHFCEngineML_L1Component(BaseOMPropulsionComponent):
    ...
    def setup(self):
        ...
        self.add_output("data:propulsion:TP_power_rate", shape=shape, lower=0.0, upper=1.0)
        self.add_output("data:propulsion:EM_power_rate", shape=shape, lower=0.0, upper=1.0)
        self.add_output("data:propulsion:electric_systems:fuel_cell:FC_efficiency", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:FC_airflow", shape=shape,units="kg/s" )
        self.add_output("data:propulsion:electric_systems:fuel_cell:V_cell", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:V_stack", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:V_pack", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:V_core", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:I_cell", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:I_stack", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:I_pack", shape=shape)
        self.add_output("data:propulsion:electric_systems:fuel_cell:I_core", shape=shape)
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:propulsion:electric_systems:fuel_cell:FC_efficiency"]=flight_point.FC_efficiency
        outputs["data:propulsion:electric_systems:fuel_cell:FC_airflow"]=flight_point.FC_airflow
        outputs["data:propulsion:electric_systems:fuel_cell:V_cell"]=flight_point.V_cell
        outputs["data:propulsion:electric_systems:fuel_cell:V_stack"]=flight_point.V_stack
        outputs["data:propulsion:electric_systems:fuel_cell:V_pack"]=flight_point.V_pack
        outputs["data:propulsion:electric_systems:fuel_cell:V_core"]=flight_point.V_core
        outputs["data:propulsion:electric_systems:fuel_cell:I_cell"]=flight_point.I_cell
        outputs["data:propulsion:electric_systems:fuel_cell:I_stack"]=flight_point.I_stack
        outputs["data:propulsion:electric_systems:fuel_cell:I_pack"]=flight_point.I_pack
        outputs["data:propulsion:electric_systems:fuel_cell:I_core"]=flight_point.I_core
