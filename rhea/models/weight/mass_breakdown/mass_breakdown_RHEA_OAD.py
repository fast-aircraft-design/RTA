...
class MassBreakdown_RHEA_OAD(om.Group):
    """
...
class PropulsionWeight(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem("hybrid_propulsion_weight", HybridPropulsionWeight(), promotes=["*"])
...
class OperationalWeight(om.Group):
    ...
    def setup(self):
        ...
        self.add_subsystem(
            "operational_weight_sum", weight_sum, promotes=["*"],
        )
