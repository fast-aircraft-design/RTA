...
class CompletePropulsionInputs(om.ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_output(
            "data:mission:sizing:climb:EM_power_rate", shape=POWER_RATE_COUNT
        )
        self.add_output(
            "data:mission:sizing:climb:TP_power_rate", shape=POWER_RATE_COUNT
        )
        ...
        self.declare_partials(
            "data:propulsion:RTO_power", "data:propulsion:RTO_power_norm", method="fd"
        )
        self.declare_partials(
            "data:propulsion:electric_systems:P_nom",
            "data:propulsion:electric_systems:P_nom_norm",
            method="fd",
        )
    ...
    def compute(self, inputs, outputs, discrete_inputs=None, discrete_outputs=None):
        ...
        outputs["data:mission:sizing:climb:EM_power_rate"] = [
            EM0,
            EM1,
            EM2,
            EM3,
        ...
        outputs["data:mission:sizing:climb:TP_power_rate"] = [
            TP0,
            TP1,
            TP2,
            TP3,
        ...
        outputs["data:propulsion:electric_systems:fuel_cell:layout:stacks"] = (
            P_nom / 100000
        )
        ...
        outputs["data:propulsion:propeller:max_power"] = (
            max((RTO_power + P_nom), RTO_power) * 1.094
        )
