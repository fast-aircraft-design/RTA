...
from rta.models.weight.cg.cg_RHEA_IN import CG_RHEA
from rta.models.weight.mass_breakdown import MassBreakdown_RHEA
from fastoad.module_management.constants import ModelDomain


@RegisterOpenMDAOSystem("rta.weight.IN", domain=ModelDomain.WEIGHT)
