...
# from rta.resources.aerodynamics.Experimental_data.Cl_low_speed_ATR72 import Cl_low_speed_ATR72
# from rta.resources.aerodynamics.Experimental_data.Cd_low_speed_ATR72 import Cd_low_speed_ATR72
