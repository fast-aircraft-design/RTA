...
from fastoad_cs25.models.aerodynamics.components.cd_compressibility import (
    CdCompressibility,
)
...
@RegisterOpenMDAOSystem("rta.aerodynamics.highspeed", domain=ModelDomain.AERODYNAMICS)
